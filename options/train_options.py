...
class TrainOptions(BaseOptions):
    ...
    def modify_options(self, opt):
        ...
        # set up saving name
        opt.model_name = '{}_{}_{}_{}_{}_Jig_{}_JigStitch_{}_JigEMA_{}_JigAug_{}_{}_{}_aug_{}_{}_{}'.format(
            opt.dataset_name, opt.image_size, opt.method, opt.arch, opt.modal, opt.jigsaw, opt.jigsaw_stitch,
            opt.jigsaw_ema, opt.jigsaw_aug, opt.jig_version, opt.mem,
...
# cat fsck-script
#
# for i in {184280..188280}
#   do
#   sudo e2fsck -yb 32768 /dev/sdd2 2> /dev/null | tail -10 | grep inode | tail -1
# done